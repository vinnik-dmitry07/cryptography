...
private:
	...
	friend class std::vector<LNum, std::allocator<LNum>>;
	friend class std::allocator<LNum>;
	friend class std::allocator_traits<std::allocator<LNum>>;
	...
	//friend class std::allocator<std::pair<const LNum, LNum>>;
	friend class std::pair<const LNum, LNum>;
};
