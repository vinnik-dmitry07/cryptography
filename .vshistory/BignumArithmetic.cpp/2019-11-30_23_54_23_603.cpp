		...
		for (int i = 0; i < certainty; i++) {
			...
			if (parts.size() > 1) {
				do {
					...
					parts[parts.size() - 1] = random(0, this->parts[parts.size() - 1]);
				} while (a >= *this - 2);
			}
			else {
				parts[0] = random(2, this->parts[0] - 3);
			}
			a = LNum(parts);
...
int main() {
	cout << LNum("479071746608894572817856880838266287637767277").is_prime(100) << endl;
