...
public:
	...
	static LNum pow_mod(const LNum& rhs, const LNum& lhs, const LNum& mod) {
		return ((rhs % mod) ^ (lhs % mod)) % mod;
	}
...
int main() {
	cout << LNum::pow_mod(LNum("24523748428"), LNum("6500000"), LNum("98723459723")) << '\n';
